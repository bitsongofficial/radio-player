...
class Btsg {
  ...
  getProposals() {
    return fetch(`${this.url}/gov/proposals`).then(response =>
      response.json()
    ).then(response =>
      response.result
    )
  ...
  getProposal(id) {
    return fetch(`${this.url}/gov/proposals/${id}`).then(response =>
      response.json()
    ).then(response =>
      response.result
    )
  ...
  getProposalTally(id) {
    return fetch(`${this.url}/gov/proposals/${id}/tally`).then(response =>
      response.json()
    ).then(response =>
      response.result
    )
